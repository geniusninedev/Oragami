package com.geniusnine.andriod.oragami.Origami;
...
public class PaperIndex extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Display.setWebViewClient(new PaperIndex.WebViewClient());

            Display.loadUrl("file:///android_asset/paper.html");
