...
import com.geniusnine.andriod.oragami.Traditional.ImageAdapter;
...
public class TaditionalAnimalsGrid extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gridview.setAdapter(new AnimalAdapter(this));


        gridview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent i = new Intent(TaditionalAnimalsGrid.this,TaditionalAnimals.class);
