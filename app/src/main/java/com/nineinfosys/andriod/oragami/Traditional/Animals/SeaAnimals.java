...
public class SeaAnimals extends FragmentActivity implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        viewPage.setOnPageChangeListener(SeaAnimals.this);
