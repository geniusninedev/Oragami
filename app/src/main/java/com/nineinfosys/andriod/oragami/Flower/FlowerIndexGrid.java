...
import com.nineinfosys.andriod.oragami.Traditional.Animals.SeaAnimals;

/**
 * Created by Supriya on 10-02-2017.
 */

public class FlowerIndexGrid extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gridview.setAdapter(new FlowerAdapter(this));


        gridview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent i = new Intent(FlowerIndexGrid.this,SeaAnimals.class);
